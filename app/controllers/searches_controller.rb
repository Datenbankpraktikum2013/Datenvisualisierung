class SearchesController < ApplicationController
  ...
  private
    ...
    def search_params
      params.require(:search).permit(:grade, :number_of_semester, :number_of_semesters, :discipline_name, :graduation_status, :gender, :nationality, :location_name, :minimum_age, :maximum_age, :search_category, :search_series, :department_number, :teaching_unit_name, :kind_of_degree)
    end
end
