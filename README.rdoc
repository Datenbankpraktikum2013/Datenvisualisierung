...
=== Steps
These installation steps describe installation on linux from scratch.
If you already have ruby 2, rubygems and bundler installed you can ignore the rvm and the login stuff.
